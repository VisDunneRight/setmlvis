...
# -*- coding: utf-8 -*-
#
# setmlvis documentation build configuration file
#
...
project = 'setmlvis'
copyright = '2023, Tarik Crnovrsanin'
author = 'Tarik Crnovrsanin'
...
_version_py = os.path.join(repo, 'setmlvis', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'setmlvis.tex', 'setmlvis Documentation',
     'Tarik Crnovrsanin', 'manual'),
]
